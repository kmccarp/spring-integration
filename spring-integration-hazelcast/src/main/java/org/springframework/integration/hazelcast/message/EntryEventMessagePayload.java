...
public class EntryEventMessagePayload<K, V> {
	...
	public boolean equals(Object o) {
		...
		return this.key.equals(that.key) && this.value == null ? that.value != null
				: !this.value.equals(that.value) && this.oldValue == null
				? that.oldValue != null : !this.oldValue.equals(that.oldValue);
